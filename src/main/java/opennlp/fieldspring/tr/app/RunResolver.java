/*
 * This class runs the resolvers in opennlp.fieldspring.tr.resolver
 */
...
public class RunResolver extends BaseApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(currentRun.getResolverType() == RESOLVER_TYPE.RANDOM) {
            ...
            resolver = new ProbabilisticResolver(currentRun.getLogFilePath(), currentRun.getMaxentModelDirInputPath(), currentRun.getWriteWeightsToFile(), currentRun.getPopComponentCoefficient(), currentRun.getDGProbOnly(), currentRun.getMEProbOnly());
        }
